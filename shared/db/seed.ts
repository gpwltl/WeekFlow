  ...
  const seedData = [
    {
      ...
      start_date: new Date(2024, 11, 27).toISOString(),
      end_date: new Date(2024, 11, 27).toISOString(),
      author: '김철수',
      status: 'completed' as const,
      started_at: new Date(2024, 11, 27).toISOString(),
      completed_at: new Date(2024, 11, 27).toISOString(),
    ...
    },
    {
      ...
      start_date: new Date(2024, 11, 25).toISOString(),
      end_date: new Date(2024, 11, 25).toISOString(),
      author: '이영희',
      status: 'in-progress' as const,
      started_at: new Date(2024, 11, 26).toISOString(),
      completed_at: new Date(2024, 11, 26).toISOString(),
      estimated_duration: 100,
      actual_duration: 100,
      interruption_count: 0
    },
